...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
    ...
    @push('crud_fields_styles')
        ...
        <link rel="stylesheet" href="{{ asset('vendor/msaid/laravel-backpack-dropzone-field/dropzone/dropzone.min.css') }}" />
    @endpush

    {{-- FIELD JS - will be loaded in the after_scripts section --}}
    @push('crud_fields_scripts')
        <!-- include dropzone js-->
        <script src="{{ asset('vendor/msaid/laravel-backpack-dropzone-field/dropzone/dropzone.min.js') }}"></script>
        <script src="{{ asset('vendor/msaid/laravel-backpack-dropzone-field/sortable/Sortable.min.js') }}"></script>
    @endpush
